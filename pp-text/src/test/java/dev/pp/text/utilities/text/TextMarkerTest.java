...
class TextMarkerTest {
    ...
    public void testAppendMarkerLineToTextLine() {
        ...
        String expected = "12345" + StringConstants.OS_LINE_BREAK +
                          " ^^";
    ...
    public void testBreakSingleTextLineAndInsertMarkerLine() {
        ...
        String expected = "" + StringConstants.OS_LINE_BREAK +
                          "^";
        ...
        expected = "012345" + StringConstants.OS_LINE_BREAK +
                          "  ^^^";
        assertEquals ( expected, TextMarker.breakSingleTextLineAndInsertMarkerLine (
        ...
        expected = "345" + StringConstants.OS_LINE_BREAK +
                   "^";
        assertEquals ( expected, TextMarker.breakSingleTextLineAndInsertMarkerLine (
            "   345", 3, '^', 1, true, null ) );

        expected = "123" + StringConstants.OS_LINE_BREAK +
                   "^";
        assertEquals ( expected, TextMarker.breakSingleTextLineAndInsertMarkerLine (
            " 123", 1, '^', 1, true, null ) );

        expected = "012" + StringConstants.OS_LINE_BREAK +
                   " ^";
        assertEquals ( expected, TextMarker.breakSingleTextLineAndInsertMarkerLine (
            "012", 1, '^', 1, true, null ) );
        ...
        expected = "   " + StringConstants.OS_LINE_BREAK +
                   " ^";
        assertEquals ( expected, TextMarker.breakSingleTextLineAndInsertMarkerLine (
            "   ", 1, '^', 1, true, null ) );
        ...
        expected = "012 " + StringConstants.OS_LINE_BREAK +
                   "456" + StringConstants.OS_LINE_BREAK +
                   "^^";
        assertEquals ( expected, TextMarker.breakSingleTextLineAndInsertMarkerLine (
            "012 456", 4, '^', 2, true, 4 ) );
        ...
        expected = "012 456" + StringConstants.OS_LINE_BREAK +
                   " 89012 " + StringConstants.OS_LINE_BREAK +
                   "45 " + StringConstants.OS_LINE_BREAK +
                   "7890123" + StringConstants.OS_LINE_BREAK +
                   "    ^^" + StringConstants.OS_LINE_BREAK +
                   "45";
        assertEquals ( expected, TextMarker.breakSingleTextLineAndInsertMarkerLine (
